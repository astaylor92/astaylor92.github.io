...
| :---: | :--- |
| <img src="/images/kabbage/extract.png"  width="70%" height="70%"> | <span class="table-steps">**Data Collection** - An in-house database querying and feature extraction layer was used to collect the feature set and DV. The feature set was ~2k features generated from transaction-level bank extracts.</p> |
